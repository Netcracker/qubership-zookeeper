...
*** Keywords ***
Setup
    ${access_control_list} =  Create Access Control List  digest  ${ADMIN_USERNAME}  ${ADMIN_PASSWORD}
    ${admin_zk} =  Connect To Zookeeper  digest  ${ADMIN_USERNAME}  ${ADMIN_PASSWORD}  ${access_control_list}
